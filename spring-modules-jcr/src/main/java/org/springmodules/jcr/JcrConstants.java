...
public class JcrConstants {
	...
	private static final String NT_NS = "http://www.jcp.org/jcr/nt/1.0";
	private static final String MIX_NS = "http://www.jcp.org/jcr/mix/1.0";

	/**
	 * Cache for jcr items.
	 */
	private final Map<Integer, String> jcrCacheMap = new HashMap<>();
	
	/**
	 * Cache for nt and mix items. (to avoid String classes and to balance the maps).
	 */
	private final Map<Integer, String> ntCacheMap = new HashMap<>();
	 ...
	 */
	private JcrConstants(Session session, boolean cache) {
		this.cache = cache;
	 ...
	 * @return
	 */
	private String resolveName(String namespace, String property) {
		// search cache 
		if (cache) {
	 ...
	 * @return
	 */
	private String computeName(String namespace, String property) {
		try {
	...
	protected void createCache() {
		...
		jcrCacheMap.put(JCR_CHILDNODEDEFINITION.hashCode(), computeName(JCR_NS,
		...
		jcrCacheMap.put(JCR_DEFAULTPRIMARYTYPE.hashCode(), computeName(JCR_NS,
		...
		jcrCacheMap.put(JCR_FROZENPRIMARYTYPE.hashCode(),
				computeName(JCR_NS, JCR_FROZENPRIMARYTYPE));
		jcrCacheMap.put(JCR_FROZENUUID.hashCode(), computeName(JCR_NS, JCR_FROZENUUID));
		jcrCacheMap.put(JCR_HASORDERABLECHILDNODES.hashCode(), computeName(JCR_NS,
		...
		jcrCacheMap.put(JCR_PRIMARYITEMNAME.hashCode(), computeName(JCR_NS, JCR_PRIMARYITEMNAME));
		jcrCacheMap.put(JCR_PROPERTYDEFINITION.hashCode(), computeName(JCR_NS,
				JCR_PROPERTYDEFINITION));
		jcrCacheMap.put(JCR_PROTECTED.hashCode(), computeName(JCR_NS, JCR_PROTECTED));
		jcrCacheMap.put(JCR_REQUIREDPRIMARYTYPES.hashCode(), computeName(JCR_NS,
		...
		jcrCacheMap.put(NT_CHILDNODEDEFINITION.hashCode(), computeName(NT_NS,
